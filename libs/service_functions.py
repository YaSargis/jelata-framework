...
def default_headers(self):
	...
	self.set_header("Access-Control-Allow-Headers","withCredentials, Access-Control-Allow-Headers, Origin,Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers")	
